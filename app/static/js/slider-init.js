...
(function ($) {
  ...
  //   "Strategic Business & Trade Consulting",
  // ];
  ...
  document.addEventListener("DOMContentLoaded", () => {
    const BudgetEventSwiper = new Swiper(".myBudgetSwiper", {
      slidesPerView: 1,
      spaceBetween: 20,
      loop: false,
      breakpoints: {
    ...
    if (nextBtn) {
      nextBtn.addEventListener("click", () => {
        BudgetEventSwiper.slideNext();
      });
    }

    if (prevBtn) {
      prevBtn.addEventListener("click", () => {
        BudgetEventSwiper.slidePrev();
      });
    }
  });
  ...
  ////////////////////////////////////////////////////
  // 04. tp-testimonial-2-slide
  var newsSlider = new Swiper(".tp-contact-slide", {
    slidesPerView: 1,
    speed: 700,
    spaceBetween: 30,
    loop: true,
